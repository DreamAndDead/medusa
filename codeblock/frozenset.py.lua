...
local s = frozenset(set {0, 1, 2, 3})
assert((len(s) == 4))
assert((operator_in(0, s)))
assert((operator_in(1, s)))
assert((operator_in(2, s)))
assert((operator_in(3, s)))
s = frozenset(set {0, 1, 2, 3})
local sc = s.copy()
assert((len(s) == 4))
assert((len(sc) == 4))
assert((operator_is(s, sc)))
local s1 = frozenset(set {1, 2, 3, 4, 5, 6})
local s2 = frozenset(set {2, 4, 6, 8})
local s3 = frozenset(set {0, 10, 3})
...
s1 = frozenset(set {1, 2, 3, 4, 5, 6})
s2 = frozenset(set {2, 4, 6, 8})
s3 = frozenset(set {0, 10, 3})
