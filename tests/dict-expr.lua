...
d = dict {[_to_null(0)] = _to_null(dict {[_to_null("a")] = _to_null(1), [_to_null("b")] = _to_null(2)}), [_to_null(1)] = _to_null(dict {[_to_null("c")] = _to_null(3), [_to_null("d")] = _to_null(4)})}
e = (function() local result = dict {} for _, k, v in d.items() do if ((math.fmod(k, 2)) == 0) then for _, nk, nv in v.items() do if (nv > 1) then result[nk] = bool(((math.fmod(nv, 2)) == 1)) and nv or (nv + 1) end end end end return result end)()
