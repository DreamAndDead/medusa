...
e = (function() local result = dict {} for _, k, v in d.items(merge_kwargs({}, {})) do result[k] = bool({}, ((mod_operator(k, 2)) == 1)) and v or 10 end return result end)()
assert(bool({}, (e[_to_null(0)] == 10)))
assert(bool({}, (e[_to_null(1)] == 1)))
assert(bool({}, (e[_to_null(2)] == 10)))
f = (function() local result = dict {} for _, k, v in d.items(merge_kwargs({}, {})) do result[bool({}, (v == 0)) and k or (v + 1)] = bool({}, ((mod_operator(k, 2)) == 1)) and v or 10 end return result end)()
...
d = dict({}, {[_to_null(0)] = _to_null(dict({}, {[_to_null("a")] = _to_null(1), [_to_null("b")] = _to_null(2)})), [_to_null(1)] = _to_null(dict({}, {[_to_null("c")] = _to_null(3), [_to_null("d")] = _to_null(4)}))})
e = (function() local result = dict {} for _, k, v in d.items(merge_kwargs({}, {})) do if bool({}, ((mod_operator(k, 2)) == 0)) then for _, nk, nv in v.items(merge_kwargs({}, {})) do if bool({}, (nv > 1)) then result[nk] = bool({}, ((mod_operator(nv, 2)) == 1)) and nv or (nv + 1) end end end end return result end)()
