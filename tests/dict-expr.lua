...
local e = (function() local result = dict {} for _, k, v in d.items(merge_kwargs({}, {})) do result[k] = v end return result end)()
local f = (function() local result = dict {} for _, k, v in d.items(merge_kwargs({}, {})) do result[v] = k end return result end)()
...
e = (function() local result = dict {} for _, k, v in d.items(merge_kwargs({}, {})) do result[k] = bool(((math.fmod(k, 2)) == 1)) and v or 10 end return result end)()
assert(bool((e[_to_null(0)] == 10)))
assert(bool((e[_to_null(1)] == 1)))
assert(bool((e[_to_null(2)] == 10)))
f = (function() local result = dict {} for _, k, v in d.items(merge_kwargs({}, {})) do result[bool((v == 0)) and k or (v + 1)] = bool(((math.fmod(k, 2)) == 1)) and v or 10 end return result end)()
assert(bool((f[_to_null(0)] == 10)))
assert(bool((f[_to_null(2)] == 1)))
assert(bool((f[_to_null(3)] == 10)))
d = dict {[_to_null(0)] = _to_null(0), [_to_null(1)] = _to_null(1), [_to_null(2)] = _to_null(2)}
e = (function() local result = dict {} for _, k, v in d.items(merge_kwargs({}, {})) do if bool((k > 1)) then result[k] = v end end return result end)()
...
e = (function() local result = dict {} for _, k, v in d.items(merge_kwargs({}, {})) do for _, nk, nv in v.items(merge_kwargs({}, {})) do result[nk] = nv end end return result end)()
assert(bool((e[_to_null("a")] == 1)))
assert(bool((e[_to_null("b")] == 2)))
assert(bool((e[_to_null("c")] == 3)))
assert(bool((e[_to_null("d")] == 4)))
d = dict {[_to_null(0)] = _to_null(dict {[_to_null("a")] = _to_null(1), [_to_null("b")] = _to_null(2)}), [_to_null(1)] = _to_null(dict {[_to_null("c")] = _to_null(3), [_to_null("d")] = _to_null(4)})}
e = (function() local result = dict {} for _, k, v in d.items(merge_kwargs({}, {})) do if bool(((math.fmod(k, 2)) == 0)) then for _, nk, nv in v.items(merge_kwargs({}, {})) do if bool((nv > 1)) then result[nk] = bool(((math.fmod(nv, 2)) == 1)) and nv or (nv + 1) end end end end return result end)()
