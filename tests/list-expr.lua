...
b = (function() local result = list({}, {}) for _, i in a do result.append({}, bool({}, ((mod_operator(i, 2)) == 1)) and i or 0) end return result end)()
assert(bool({}, (b[_to_null(0)] == 0)))
assert(bool({}, (b[_to_null(1)] == 1)))
assert(bool({}, (b[_to_null(2)] == 0)))
assert(bool({}, (b[_to_null(3)] == 3)))
a = list({}, {_to_null(0, 1, 2, 3)})
b = (function() local result = list({}, {}) for _, i in a do if bool({}, ((mod_operator(i, 2)) == 1)) then result.append({}, i) end end return result end)()
