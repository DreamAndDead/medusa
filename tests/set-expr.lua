...
b = (function() local result = set({}, {}) for _, i in a do result.add({}, bool({}, ((mod_operator(i, 2)) == 1)) and i or 0) end return result end)()
assert(bool({}, (len(merge_kwargs({}, {}), b) == 3)))
assert(bool({}, (operator_in(0, b))))
assert(bool({}, (operator_in(1, b))))
assert(bool({}, (operator_in(3, b))))
a = set({}, {_to_null(0, 1, 2, 3)})
b = (function() local result = set({}, {}) for _, i in a do if bool({}, ((mod_operator(i, 2)) == 1)) then result.add({}, i) end end return result end)()
